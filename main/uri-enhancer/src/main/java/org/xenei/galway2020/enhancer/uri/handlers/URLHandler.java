...
public interface URLHandler {
	...
	public static final Property content_type = ResourceFactory.createProperty( "http://www.w3.org/2011/http#", "content-type");
	public static final Property content_length = ResourceFactory.createProperty( "http://www.w3.org/2011/http#", "content-length");
	 ...
	 * 
	 * Enhancers must be careful not to write data into the queried model as this may result
	 * in a ConcurrentModificationException for in memory graphs.
	 *
	 */
	public void handle();
