...
<head>
    ...
    <link type="text/css" href="${pageContext.request.contextPath}/js/dataTables-1.10.7/dataTables.bootstrap.css" rel="stylesheet">
    <!--<link type="text/css" href="${pageContext.request.contextPath}/js/dataTables-1.10.7/jquery.dataTables.css" rel="stylesheet">-->
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/dataTables-1.10.7/jquery.dataTables.min.js"></script>
...
<body>
        ...
        <div class="row">
            <div class="col-sm-3 col-md-2 sidebar">
                <!--<ul class="nav nav-sidebar">
                    <li class="${pageContext.request.requestURI eq '${pageContext.request.contextPath}' ? ' active' : ''}"><a href="/g2020-dashboard-1.0">Overview <span class="sr-only">(current)</span></a></li>
                ...
                <ul class="nav nav-sidebar">
                    <li class="${pageContext.request.requestURI eq '${pageContext.request.contextPath}/topEngaged' ? ' active' : ''}"><a href="${pageContext.request.contextPath}/topEngaged">Top Engaged Users</a></li>
                    <li class="${pageContext.request.requestURI eq '${pageContext.request.contextPath}/topInfluential' ? ' active' : ''}"><a href="${pageContext.request.contextPath}/topInfluential">Top Influential Users</a></li>
                    <li class="${pageContext.request.requestURI eq '${pageContext.request.contextPath}/topActivists' ? ' active' : ''}"><a href="${pageContext.request.contextPath}/topActivists">Top Active Users</a></li>
                </ul>
            </div><!-- sidebar -->
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/dataTables-1.10.7/dataTables.bootstrap.js"></script>
